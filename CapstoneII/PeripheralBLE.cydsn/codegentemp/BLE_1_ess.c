...
static CYBLE_ESSS_CHAR_T esssCharIdx0[0x01u] = {
    {
        0x0012u, /* Handle of the Descriptor Value Changed characteristic */ 
...
static CYBLE_ESSS_CHAR_T esssCharIdx12[0x01u] = {
    {
        0x0015u, /* Handle of the Temperature characteristic */ 
        
            /* Array of Descriptors handles */
            {
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Client Characteristic Configuration descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Characteristic Extended Properties descriptor */ 
                0x0016u, /* Handle of the ES Measurement descriptor */ 
                0x0017u, /* Handle of the ES Trigger Setting descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the ES Trigger Setting 2 descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the ES Trigger Setting 3 descriptor */ 
                CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the ES Configuration descriptor */ 
...
uint8 cyBle_esssCharInstances[0x15u] = {
    0x01u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x01u, 0x00u, 0x00u, 0x00u,
    0x00u, 0x00u, 0x00u, 0x00u, 0x00u
};

const CYBLE_ESSS_T cyBle_esss =
{
    0x0010u,    /* Handle of the ESS service */
    {
        {
            &esssCharIdx0[0], /* Handle of the Descriptor Value Changed characteristic */ 
        }, 
        {
            NULL, /* Handle of the Apparent Wind Direction characteristic */ 
        }, 
        {
            NULL, /* Handle of the Apparent Wind Speed characteristic */ 
        }, 
        {
            NULL, /* Handle of the Dew Point characteristic */ 
        }, 
        {
            NULL, /* Handle of the Elevation characteristic */ 
        }, 
        {
            NULL, /* Handle of the Gust Factor characteristic */ 
        }, 
        {
            NULL, /* Handle of the Heat Index characteristic */ 
        }, 
        {
            NULL, /* Handle of the Humidity characteristic */ 
        }, 
        {
            NULL, /* Handle of the Irradiance characteristic */ 
        }, 
        {
            NULL, /* Handle of the Pollen Concentration characteristic */ 
        }, 
        {
            NULL, /* Handle of the Rainfall characteristic */ 
        }, 
        {
            NULL, /* Handle of the Pressure characteristic */ 
        }, 
        {
            &esssCharIdx12[0], /* Handle of the Temperature characteristic */ 
        }, 
        {
            NULL, /* Handle of the True Wind Direction characteristic */ 
        }, 
        {
            NULL, /* Handle of the True Wind Speed characteristic */ 
        }, 
        {
            NULL, /* Handle of the UV Index characteristic */ 
        }, 
        {
            NULL, /* Handle of the Wind Chill characteristic */ 
        }, 
        {
            NULL, /* Handle of the Barometric Pressure Trend characteristic */ 
        }, 
        {
            NULL, /* Handle of the Magnetic Declination characteristic */ 
        }, 
        {
            NULL, /* Handle of the Magnetic Flux Density - 2D characteristic */ 
        }, 
        {
            NULL, /* Handle of the Magnetic Flux Density - 3D characteristic */ 
        }, 
    },
};
