...
module top ;
	...
	wire [0:0] tmpOE__LCD_init_net;
	wire [0:0] tmpIO_0__LCD_init_net;
	wire [0:0] tmpINTERRUPT_0__LCD_init_net;
	electrical [0:0] tmpSIOVREF__LCD_init_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_init
		 (.oe(tmpOE__LCD_init_net),
		  .y({1'b0}),
		  .fb({Net_406}),
		  .io({tmpIO_0__LCD_init_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_init_net),
		  .interrupt({tmpINTERRUPT_0__LCD_init_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_init_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
